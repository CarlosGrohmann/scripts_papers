...
# 
# the function does not check for projection, so UTM or other planar
# projection is recommended
# 
# modified for python3 f-strings
##############################################################################
...
def azim(infile):
    ...
    print(f'Linear features in file: {numFeatures}')
    print('')
    ...
    print(f'len azimuth: {len(azimuth)}')
    # return results
