...
patched = ['aw3d30_avg_Everest','tdx12_SantaCatarina','tdx30_SantaCatarina','srtm30_SantaCatarina',\
'aster30_SantaCatarina','aw3d30_avg_SantaCatarina', 'tdx12_SerraMar', \
'tdx30_SerraMar', 'srtm30_SerraMar', 'aster30_SerraMar','aw3d30_avg_SerraMar']
...
#----------------------------------------------------
#----------------------------------------------------
#  Create vector mask of coastal areas to limit random point distribution
#----------------------------------------------------
#----------------------------------------------------
...
#----------------------------------------------------
#----------------------------------------------------
coast = ['tdx12_SantaCatarina','tdx30_SerraMar','srtm30_SantaCatarina','srtm30_SerraMar','aster30_SantaCatarina'\
,'aster30_SerraMar','aw3d30_avg_SantaCatarina','aw3d30_avg_SerraMar']
...
#----------------------------------------------------
#----------------------------------------------------
#  Final lists of tiles
#----------------------------------------------------
#----------------------------------------------------

tdx = ['tdx12_Araca', 'tdx12_Barcelos', 'tdx12_Pantanal', 'tdx12_SerraMar', 'tdx12_RioClaro', \
'tdx12_Iporanga', 'tdx12_SantaCatarina', 'tdx30_Araca', 'tdx30_Barcelos', 'tdx30_Pantanal', \
'tdx30_SerraMar', 'tdx30_RioClaro', 'tdx30_Iporanga', 'tdx30_SantaCatarina']
...
alos_avg = ['aw3d30_avg_Araca', 'aw3d30_avg_Barcelos', 'aw3d30_avg_Pantanal', 'aw3d30_avg_SerraMar', \
'aw3d30_avg_RioClaro', 'aw3d30_avg_Iporanga', 'aw3d30_avg_SantaCatarina']


# create lists by geographic area:
tiles_list = tdx + srtm + aster + alos_med + alos_avg

araca = [tile for tile in tiles_list if 'Araca' in tile]
barcelos = [tile for tile in tiles_list if 'Barcelos' in tile]
pantanal = [tile for tile in tiles_list if 'Pantanal' in tile]
serramar = [tile for tile in tiles_list if 'Serra' in tile]
rioclaro = [tile for tile in tiles_list if 'Rio' in tile]
iporanga = [tile for tile in tiles_list if 'Iporanga' in tile]
santacatarina = [tile for tile in tiles_list if 'Santa' in tile]


araca = ['tdx12_Araca', 'tdx30_Araca', 'srtm30_Araca', 'aster30_Araca', 'aw3d30_avg_Araca']
barcelos = ['tdx12_Barcelos', 'tdx30_Barcelos', 'srtm30_Barcelos', 'aster30_Barcelos', 'aw3d30_avg_Barcelos']
pantanal = ['tdx12_Pantanal', 'tdx30_Pantanal', 'srtm30_Pantanal', 'aster30_Pantanal', 'aw3d30_avg_Pantanal']
serramar = ['tdx12_SerraMar', 'tdx30_SerraMar', 'srtm30_SerraMar', 'aster30_SerraMar', 'aw3d30_avg_SerraMar']
rioclaro = ['tdx12_RioClaro', 'tdx30_RioClaro', 'srtm30_RioClaro', 'aster30_RioClaro', 'aw3d30_avg_RioClaro']
iporanga = ['tdx12_Iporanga', 'tdx30_Iporanga', 'srtm30_Iporanga', 'aster30_Iporanga', 'aw3d30_avg_Iporanga']
santacatarina = ['tdx12_SantaCatarina', 'tdx30_SantaCatarina', 'srtm30_SantaCatarina', 'aster30_SantaCatarina', 'aw3d30_avg_SantaCatarina']

areas=[araca,barcelos,pantanal,serramar,rioclaro,iporanga,santacatarina]
...
# fix  colors, flags: e=equalize hist
...
for dem in itertools.chain.from_iterable(areas):
    ...
    grass.run_command('d.mon', start='png', output=dem+'.png', resolution = '2', \
    ...
    grass.run_command('d.legend', raster=dem, flags='sb', at='4,25,2,4', font='Helvetica', fontsize=14, bgcolor='240:240:240')
...
for map_ge in maps_gearth:
    ...
    grass.run_command('d.mon', start='png', output=map_ge+'.png', resolution = '2', \
        height=500, width=500, overwrite=True)
